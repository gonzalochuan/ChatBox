...
app.post("/admin/import-b6", async (req, res) => {
  try {
    const seedKeyHeader = String(req.headers["x-seed-key"] || "");
    const seedKeyEnv = String(process.env.SEED_KEY || "");
    ...
    const names: Array<{ last: string; first: string }> = [
      { last: "MADRAZO", first: "CYBER JADE" },
      { last: "JALANDO-ON", first: "NATHANIEL" },
      { last: "FLORES", first: "CHESTER JOHN" },
      { last: "ESNARDO", first: "JOSHUA" },
      { last: "BARRETTO", first: "FRANK REED" },
      { last: "GRACILLA", first: "KIAN ASHLEI" },
      { last: "ACAS", first: "KHOBE JOHN" },
      { last: "PALMA", first: "ROMMEL" },
      { last: "VENTURA", first: "JAY-AR" },
      { last: "ALIDO", first: "MICHELLE" },
      { last: "SORITA", first: "JAN MARK" },
      { last: "CAMPOMANES", first: "NIGEL CARESSE" },
      { last: "BLASCO", first: "JAY RYAN" },
      { last: "TULIAO", first: "ANDRE" },
      { last: "SORIANO", first: "DEWEY VINCE" },
      { last: "DAGUM", first: "CUTIE" },
      { last: "SAGARINO", first: "SHEPRIL HEART" },
      { last: "MUNDA", first: "KEITH JOSH" },
      { last: "GONZALES", first: "CLARK JUSTINE" },
      { last: "FAENSOLIN", first: "JENNY BOB" },
      { last: "NEDRUDA", first: "REY LAURENCE" },
      { last: "PANES", first: "SHERYN MEL" },
      { last: "PEREZ", first: "MARC ERROL" },
      { last: "LANOTAN", first: "VICTORINA" },
    ];
    ...
    // eslint-disable-next-line no-console
    console.error("/admin/import-b6 error", e);
    return res.status(500).json({ error: "import_failed" });
  }
});
...
app.post("/admin/import-b3", async (req, res) => {
  try {
    ...
    const domains = ["seait.edu", "seait.com", "gmail.com", "school.edu", "campus.edu"];

    const names: Array<{ last: string; first: string }> = [
      { last: "ABUEME", first: "YZHEN STEFFEN CLARK" },
      { last: "AGUSTIN", first: "PATRICK JUSTIN" },
      { last: "ALOOT", first: "JHON DENVER" },
      { last: "ANDRADE", first: "GLESTHER JOHN" },
      { last: "ANG", first: "STEPHEN BRYLLE" },
      { last: "AVENIDO", first: "REY GEORGE" },
      { last: "BALTERO", first: "JONAMAE" },
      { last: "BARRIOS", first: "ARON JAMES" },
      { last: "CABANBAN", first: "CYNIE" },
      { last: "CADUNGOG", first: "KEAN JAMES" },
      { last: "CONSAD", first: "REYNALDO, JR." },
      { last: "COTIMAR", first: "MARPY" },
      { last: "CURAY", first: "ARJAY" },
      { last: "DALON", first: "RONIEL" },
      { last: "ENRIQUEZ", first: "CHRISTIAN LAWRENCE" },
      { last: "ESLABAN", first: "GLENN" },
      { last: "FAJADAN", first: "KYLE" },
      { last: "GERASMIA", first: "ARNETH BABES" },
      { last: "GIGANTE", first: "JOBERT" },
      { last: "GUADALUPE", first: "RIC JOHN" },
      { last: "HATULAN", first: "MARIEL" },
      { last: "JONGAY", first: "RAJAA" },
      { last: "LANDERO", first: "JOANA MAE" },
      { last: "LAPIZAR", first: "LENARD JAY" },
      { last: "LEMBAGA", first: "CHRISTIAN" },
      { last: "MASENDO", first: "ARHA" },
      { last: "MIJARES", first: "AXL JOHN" },
      { last: "MONTILLA", first: "ANDY KENETH" },
      { last: "MORALES", first: "FRANCIS JOHN" },
      { last: "NABE", first: "FRANCIS ANTHONY" },
      { last: "PALMA", first: "ELMA JOY" },
      { last: "PIANG", first: "JULYDINE" },
      { last: "QUIÑANOLA", first: "FERG JUNE" },
      { last: "SALARZA", first: "JHON MARK" },
      { last: "TAGHAP", first: "MARK JEREMY" },
      { last: "VILLAGRACIA", first: "KRISTINE HEART" },
      { last: "VILLALOBOS", first: "JOSHUA" },
      { last: "VILLANUEVA", first: "MARIE JAME" },
      { last: "VILLANUEVA", first: "CHARLENE" },
      { last: "ZALDIVIA", first: "KIM ROGER" },
    ];
    ...
    // eslint-disable-next-line no-console
    console.error("/admin/import-b3 error", e);
    return res.status(500).json({ error: "import_failed" });
  }
});

app.post("/admin/import-b4", async (req, res) => {
  try {
    const seedKeyHeader = String(req.headers["x-seed-key"] || "");
    const seedKeyEnv = String(process.env.SEED_KEY || "");
    ...
    const names: Array<{ last: string; first: string }> = [
      { last: "TUMINDEG", first: "SAIDA" },
      { last: "CARTIL", first: "JACQUILIN" },
      { last: "MANABE", first: "KRISTA JANE" },
      { last: "FLORES", first: "MERVIC HARVEE" },
      { last: "ORBETA", first: "MATTHEW GABRIEL" },
      { last: "MAGNINDALAT", first: "FARIDA" },
      { last: "TEMPERATURA", first: "DOFFER JOHN" },
      { last: "ACHAS", first: "DANIELLE JANE" },
      { last: "TESALUNA", first: "KURT ALLAN" },
      { last: "FUYONAN", first: "ANIE ROSE" },
      { last: "CAPA", first: "JAY-AR" },
      { last: "TUBLE", first: "ASHER JAY" },
      { last: "VERALLO", first: "JOLINA" },
      { last: "ARTIGO", first: "NOVEJANE" },
      { last: "YONIDO", first: "ANGEL JADE" },
      { last: "TULIO", first: "CHRISTIAN" },
      { last: "PACQUIAO", first: "HEART JOY" },
      { last: "TAGUAS", first: "KAREN GREACE" },
      { last: "TUMANDA", first: "EARL JADE" },
      { last: "RUSIANA", first: "LLOYD VENCENT" },
      { last: "LIBRADA", first: "REGINE" },
      { last: "MACMOD", first: "YOUSEF" },
      { last: "MANGALAY", first: "ANGELINE" },
      { last: "PATANI", first: "CEZAR IAN" },
      { last: "QUILLING", first: "MHEL JOHN" },
      { last: "PAPNA", first: "KIER" },
      { last: "HURGO", first: "CLIFFORD" },
      { last: "POLICARPIO", first: "RONEL" },
      { last: "PATANI", first: "BEN FRANCIS" },
      { last: "PAMISA", first: "MARIEBIL" },
      { last: "MECATOR", first: "FLOYD" },
      { last: "EMPUERTO", first: "JERALDINE" },
      { last: "BONIFACIO", first: "JHUNRYL CYM" },
      { last: "DALAMBAN", first: "FRANK LLOYD" },
      { last: "CRUZ", first: "JULIUS KENNETH" },
      { last: "LAGMAN", first: "GIAN DAIRO" },
      { last: "ZONIO", first: "RICA MAE" },
      { last: "ESTELLORE", first: "SHERWIN" },
    ];
    ...
    // eslint-disable-next-line no-console
    console.error("/admin/import-b4 error", e);
    return res.status(500).json({ error: "import_failed" });
  }
});
...
app.post("/admin/seed-students", async (req, res) => {
  try {
    ...
    for (let i = 0; i < 50; i++) {
      ...
      created.push({ email, name: fullName, yearLevel, block });
    }

    return res.status(201).json({
      message: "Seeded 50 students",
      created: created.length,
      skipped: skipped.length,
      password,
      students: created,
...
app.post("/admin/import-b1", async (req, res) => {
  try {
    const seedKeyHeader = String(req.headers["x-seed-key"] || "");
    const seedKeyEnv = String(process.env.SEED_KEY || "");
    ...
    const domains = ["seait.edu", "seait.com", "school.edu", "campus.edu"];

    const names: Array<{ last: string; first: string }> = [
      { last: "ACAIN", first: "JAY AR" },
      { last: "ACOSTA", first: "NHIEL JOHN" },
      { last: "AFABLE", first: "MARC ANTHON" },
      { last: "AKNA", first: "KENNETH JAMES" },
      { last: "ALCUZAR (MUTE & DEAF)", first: "GREVIE ANN" },
      { last: "ALIVIA", first: "JOSHUA" },
      { last: "AMBROSIO", first: "KAYE" },
      { last: "ARNAEZ", first: "FRANCIS ANDREW" },
      { last: "BACONGCO", first: "JESILLO" },
      { last: "BASILANGO", first: "ANGELIE" },
      { last: "BINGIL (MUTE & DEAF)", first: "BRENT" },
      { last: "CALAMBRO", first: "RAYMUND" },
      { last: "CAMBAS", first: "KIM JEMA" },
      { last: "CHUAN", first: "GONZALO, JR." },
      { last: "DELA GRACIA", first: "CHRIZEL" },
      { last: "ESTRELLA", first: "JOSELARY, JR." },
      { last: "GUMARAN", first: "JIMMY, JR." },
      { last: "HERNIA", first: "ARVIN" },
      { last: "HOLLERO", first: "HAZEL ANN" },
      { last: "KALIM", first: "ALABENA" },
      { last: "LABAO", first: "RYNIE LYN" },
      { last: "LADARAN", first: "QUEEN LOVE" },
      { last: "LAGMAY", first: "MARJORIE" },
      { last: "LEBRILLA", first: "HENZ AUGIE" },
      { last: "MACALISANG", first: "JEROME" },
      { last: "MESILLIONES", first: "CARL" },
      { last: "MISAL", first: "JASON" },
      { last: "NOFIEL", first: "MIEKYLLA" },
      { last: "PALOMAR", first: "ALDREN" },
      { last: "PAQUIT (MUTE & DEAF)", first: "OLIVER" },
      { last: "PARREÑO", first: "JENNY ROSE" },
      { last: "PEDI-AN", first: "ADRIAN" },
      { last: "SAPLAD", first: "JHAYSON" },
      { last: "SOBERANO", first: "CHERRY ANN" },
      { last: "TABLIGAN", first: "ALEX, JR." },
      { last: "TORRE (MUTE & DEAF)", first: "IVAN RICK" },
      { last: "YAGO", first: "ADULF SELWYN" },
      { last: "ZAFICO", first: "LLOWEL DAVE" },
      { last: "ZARSA", first: "BRIAN JAY" },
      { last: "CAALIM", first: "NIKKO" },
    ];
    ...
    for (const row of names) {
      const cleanLast = String(row.last || "").trim();
      const cleanFirst = String(row.first || "").trim();
      const fullName = `${cleanFirst} ${cleanLast}`.replace(/\s+/g, " ").trim();
      const nickname = cleanFirst.split(/\s|,/).filter(Boolean)[0] || cleanLast.split(/\s|,/).filter(Boolean)[0] || "Student";

      const baseLocal = `${slug(cleanFirst)}.${slug(cleanLast)}`.replace(/\.+/g, ".").replace(/^\.|\.$/g, "") || `student.${randDigits(4)}`;
      const domain = pick(domains);
    ...
    // eslint-disable-next-line no-console
    console.error("/admin/import-b1 error", e);
    return res.status(500).json({ error: "import_failed" });
  }
});

app.post("/admin/import-b2", async (req, res) => {
  try {
    const seedKeyHeader = String(req.headers["x-seed-key"] || "");
    const seedKeyEnv = String(process.env.SEED_KEY || "");
    ...
    const names: Array<{ last: string; first: string }> = [
      { last: "ABADINAS", first: "JOSHEL MAE" },
      { last: "ABIERA", first: "LUIZ ANTONIO" },
      { last: "ACHARON", first: "MARLOU" },
      { last: "ADOLFO", first: "ELPHEN, JR." },
      { last: "ANINAG", first: "DEBBIE MAE" },
      { last: "BALABA", first: "KRISTINA CASSANDRA" },
      { last: "BALMORIA", first: "FRITZ GERALD" },
      { last: "BALONGA", first: "GEMELLOYD" },
      { last: "BANTILLO", first: "LEMUEL, JR." },
      { last: "BARTOLOME", first: "SHEKINAH FAITH" },
      { last: "BUDLONG", first: "JUSTIN MARC" },
      { last: "BURAN", first: "SHERYL JANE" },
      { last: "BUTIL", first: "ZYLE" },
      { last: "CABALES", first: "KURT NIEL" },
      { last: "CARREON", first: "HONEYYE" },
      { last: "CATOR", first: "JOHN" },
      { last: "CUNANAN", first: "JEMAR KYLE" },
      { last: "DAEL", first: "ANTHONY" },
      { last: "DIAZ", first: "JOHN CARL" },
      { last: "DINOPOL", first: "JOHNCENT" },
      { last: "EGONIO", first: "PRINCESS JEVONNE" },
      { last: "ELISAN", first: "VICTOR, JR." },
      { last: "EREDIANO", first: "MARY ANN" },
      { last: "FACTOR", first: "RAFAEL" },
      { last: "GARDOSE", first: "JE-MARK" },
      { last: "LASPRILLA", first: "PAULINE" },
      { last: "LEGARTO", first: "EDEN FAYE" },
      { last: "LUNASCO", first: "GINA JEAN JOY" },
      { last: "MAHUSAY", first: "PRINCESS JOYCE" },
      { last: "MALIBAGO", first: "JANDRY" },
      { last: "OÑAS", first: "RANCY" },
      { last: "ONGIT", first: "JEMAICA" },
      { last: "PARROCHA", first: "ANGEL" },
      { last: "QUINOVEVA", first: "JAMES" },
      { last: "REBITE", first: "JAMAICA" },
      { last: "REFUGIO", first: "MARK JOSEPH" },
      { last: "REPOPONIO", first: "MJ" },
      { last: "SARANGAYA", first: "JOHN DAVID" },
      { last: "ZALDARRIAGA", first: "ZENLEE" },
    ];
    ...
    // eslint-disable-next-line no-console
    console.error("/admin/import-b2 error", e);
    return res.status(500).json({ error: "import_failed" });
  }
});
